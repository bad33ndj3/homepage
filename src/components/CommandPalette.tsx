...
export function CommandPalette({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-slate-900/50 px-4 py-16 backdrop-blur-sm">
      <div className="w-full max-w-2xl overflow-hidden rounded-[16px] border border-white/50 bg-white/70 shadow-[0_24px_60px_rgba(15,23,42,0.25)] backdrop-blur-2xl dark:border-white/10 dark:bg-[#0f172a]/80">
        <div className="flex items-center gap-3 border-b border-white/50 bg-white/60 px-4 py-3 text-sm text-slate-500 dark:border-white/10 dark:bg-white/10 dark:text-slate-200">
          <Input
            ref={inputRef}
